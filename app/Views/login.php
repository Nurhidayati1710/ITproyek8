...
<head>
    ...
    <style>
        .background-image {
            background-image: url('sbadmin/img/321.jpg');
            background-size: cover;
            background-position: center;
            width: 100%;
            height: 100vh; /* Menyesuaikan tinggi elemen sesuai kebutuhan */
        }
    </style>
</head>
...
<body class="background-image">
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-x- col-lg-12 col-md-9">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user">
                                        ...
                                        <a href="<?= site_url('/admin/barang') ?>" class="btn btn-success btn-user btn-block">
                                            Login
                                        </a>
                                    </form>
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="register.html" style="color: white;">Register?</a>
                                    </div>
                                </div>
                            </div>
                        </div>
